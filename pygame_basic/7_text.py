...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\mussy\\OneDrive\\바탕 화면\\PythonStudy\\pygame_basic\\enemy.png")
...
# 폰트 정의
game_font = pygame.font.Font(None, 40)  # 퐅트 객체 생성 (폰트, 크기)
...
while running:
    ...
    # 타이머 집어넣기
    # 경과 시간
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 # 경과시간 (ms) 을 1000 으로 나누어서 초 (s) 단위로 표시

    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255, 255, 255))
    # 출력할 글자, True, 글자 색상
    screen.blit(timer, (10, 10))

    # 만약 시간이 0 이하이면 게임을 종료
